...
const CourseLessonItemComponent = ({courseId, moduleId, lesson, deleteLesson, updateLesson, editLesson, saveLesson}) =>
    <li className="nav-item nav-link">
        {
            !lesson.editing &&
            <span>
                <Link to={`/course_editor/${courseId}/modules/${moduleId}/lessons/${lesson._id}`}>
